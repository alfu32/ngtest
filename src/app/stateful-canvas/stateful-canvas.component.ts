...
@Component({
  selector: 'app-stateful-canvas',
  templateUrl: './stateful-canvas.component.html',
  styleUrls: ['./stateful-canvas.component.css']
})
export class StatefulCanvasComponent implements OnInit {
  @Input() drawables: any[];
  @Output() statechange: EventEmitter<any> = new EventEmitter();
  @ViewChild('elmCanvas') canvasRef: ElementRef;
